...
// Fix the layout etc
if (!function_exists('woostore_before_content')) {
...
if (!function_exists('woostore_after_content')) {
...
if (!function_exists('woostore_breadcrumb')) {
...
if (!function_exists('woostore_loop_columns')) {
